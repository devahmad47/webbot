...
const Site = () => {
  ...
  const naviagte = useNavigate();
   console.log("storesites===>",storeAllSites)
  // const handelChangeInput = (e) => {
  //   setfilterSite(e.target.value);
  // };
  // useEffect(() => {
  //   if (filterSite === "All") {
  //     setfilteredSites(storeAllSites);
  //   } else {
  //     const filteredSites = storeAllSites.filter((site) =>
  //       site.siteName.includes(filterSite)
  //     );
  //     setfilteredSites(filteredSites);
  //   }
  // }, [filterSite, storeAllSites]);
  return (
    <>
    {
      ...
      <div>
        ...
        <div className="flex items-center justify-start gap-2  w-full">
              {storeAllSites && storeAllSites.length > 0 && (
                <span className="font-bold"> {storeAllSites.length}</span>
              )}
              ...
              <div className="text-right w-full flex items-center justify-end">
                <div className="flex items-center justify-center gap-2">
                  ...
                  <div
                    ...
                    onClick={() => {
                      saveMiqatsToJSON(storeAllSites, "doors");
                    }}
                  >
                    <svg
          ...
          <div className="grid grid-cols-4 md:grid-cols-7 bg-gray-50 text-center  my-4 p-2">
            ...
            <h2 className="px-2 col-span-1   text-md font-bold  ">Longitude</h2>
            <h2 className="px-2 col-span-1   text-md font-bold  ">Actions</h2>
            <h2 className="px-2 col-span-1   text-md font-bold  ">Map</h2>
          </div>
        </div>
        {storeAllSites && storeAllSites.length > 0 ? (
          storeAllSites.map((site, index) => {
            return (
              <div
                key={index}
              ...
              >
                ...
                <div className="text-sm font-medium col-span-1 flex items-center justify-center gap-2 text-gray-900">
                  ...
                  <button
                    onClick={() => {
                      naviagte(`/Admin/EditSite/${site._id}`);
                    }}
                ...
                <div className="text-sm px-2 font-medium col-span-1  md:block hidden  text-gray-900"></div>
                <div className="text-sm px-2 font-medium col-span-1  md:block hidden  text-gray-900">
                  {site.longitude}
                </div>
              </div>
